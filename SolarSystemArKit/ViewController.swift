...
//  SolarSystemArKit
//
//  Created by Ahmet Hakan Altıparmak on 18.09.2024.
//
...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let mars = createSphere(radius: 0.3, content: "mars.png", vector: SCNVector3(0.5 , 0.2, -1))
        
        let venus = createSphere(radius: 0.2, content: "venus.png", vector: SCNVector3(1, 0.2, -1))
